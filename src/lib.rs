...
//!
//! ```rust
//! use rust_releases_core::{FetchResources, IndexBuilder, Channel, ReleaseIndex};
...
pub use rust_releases_core::{
    semver, Channel, CoreError, CoreResult, FetchResources, IndexBuilder, Release, ReleaseIndex,
};
